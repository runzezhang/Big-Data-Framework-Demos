...
def main():
    ...
    training_data, training_cls, training_maxvar = read_data_set("train.arff")
    testing_data, testing_cls, _ = read_data_set("test.arff")

    acc1, acc2 = train(training_data, testing_data, training_maxvar)

    print("Accuracy: {}%, {}%".format(acc1,acc2))
